...
public struct FileHandler: Codable, Equatable, Identifiable {
    public let id: UUID
...
public struct FolderRule: Codable, Equatable, Identifiable {
    public let id: UUID
    public var enabled: Bool
    /// 绝对路径；不做符号链接解析。
...
public struct ApplicationReference: Codable, Equatable, Hashable {
